...
class getSecurity_Listener_UserChecker_MainService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['security.listener.user_checker.main'])) {
            return $container->privates['security.listener.user_checker.main'];
        }

        return $container->privates['security.listener.user_checker.main'] = new \Symfony\Component\Security\Http\EventListener\UserCheckerListener(new \App\Security\UserChecker($a, ($container->privates['App\\Repository\\UtilisateurRepository'] ?? $container->load('getUtilisateurRepositoryService'))));
    }
}
