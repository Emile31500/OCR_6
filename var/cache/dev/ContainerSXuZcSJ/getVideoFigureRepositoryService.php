 ...
 */
class getVideoFigureRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\VideoFigureRepository' shared autowired service.
     *
     * @return \App\Repository\VideoFigureRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'VideoFigureRepository.php';

        return $container->privates['App\\Repository\\VideoFigureRepository'] = new \App\Repository\VideoFigureRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
