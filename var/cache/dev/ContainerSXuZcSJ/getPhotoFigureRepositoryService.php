 ...
 */
class getPhotoFigureRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PhotoFigureRepository' shared autowired service.
     *
     * @return \App\Repository\PhotoFigureRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PhotoFigureRepository.php';

        return $container->privates['App\\Repository\\PhotoFigureRepository'] = new \App\Repository\PhotoFigureRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
