...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "@WebProfiler/Collector/validator.html.twig", "/opt/lampp/htdocs/Projet OC6/vendor/symfony/web-profiler-bundle/Resources/views/Collector/validator.html.twig");
    }
}
