...
class __TwigTemplate_9db760ac05b55405c8149080073b759c extends Template
{
 ...
 ";
    ...
    <p>
        ";
        // line 16
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 16, $this->source); })()), "article", [], "any", false, false, false, 16), 'row');
        echo "
    </p>
    <p>
        ";
