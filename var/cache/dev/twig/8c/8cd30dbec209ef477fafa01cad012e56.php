...
class __TwigTemplate_1daac060add22dc9d41231628045660a extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"example-wrapper\">
    <h2 class=\"mt-5 mb-5\"> {{ controller_name }}! </h2>
    <p>
        Erreur {{code}} : {{message}}.
    </p>
</div>
{% endblock %}
", "error/index.html.twig", "/opt/lampp/htdocs/Projet OC6/templates/error/index.html.twig");
    }
}
