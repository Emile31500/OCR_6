...
";
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["figure"]) {
            ...
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["figure"], "photo", [], "any", false, false, false, 36), "url", [], "any", false, false, false, 36), "html", null, true);
            echo "\" alt=\"";
            ...
            echo "\"/>
                <div class=\"card-body\">
                    <a href=\"";
            // line 38
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_figure", ["slug" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["figure"], "figure", [], "any", false, false, false, 38), "slug", [], "any", false, false, false, 38)]), "html", null, true);
            echo "\" >
                        <h3 class=\"col-8 h4 text-dark\"> ";
            // line 39
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["figure"], "figure", [], "any", false, false, false, 39), "nom", [], "any", false, false, false, 39), "html", null, true);
            echo " </h3>
                    </a>
                    ";
            // line 41
            if ( !(null === twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 41, $this->source); })()), "user", [], "any", false, false, false, 41))) {
                // line 42
                echo "                        ";
                if ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 42, $this->source); })()), "user", [], "any", false, false, false, 42), "roles", [], "any", false, false, false, 42), 0, [], "array", false, false, false, 42) == "administrator")) {
                    // line 43
                    echo "                            <div class=\"col-2 edit-card-div\">
                                <a href=\"";
                    // line 44
                    echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_edition_figure", ["slug" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["figure"], "figure", [], "any", false, false, false, 44), "slug", [], "any", false, false, false, 44)]), "html", null, true);
                    echo "\">
                            ...
                            <div class=\"col-2 trash-card-div\">
                                <a href=\"";
                    // line 51
                    echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_supression_figure", ["slug" => twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["figure"], "figure", [], "any", false, false, false, 51), "slug", [], "any", false, false, false, 51)]), "html", null, true);
                    echo "\">
...
";
    ...
    {
        return array (  268 => 76,  258 => 75,  245 => 73,  235 => 72,  217 => 63,  208 => 59,  205 => 58,  195 => 51,  185 => 44,  182 => 43,  179 => 42,  177 => 41,  172 => 39,  168 => 38,  160 => 36,  156 => 34,  152 => 33,  149 => 32,  146 => 31,  138 => 27,  135 => 26,  132 => 25,  122 => 24,  93 => 6,  83 => 5,  62 => 3,  39 => 1,);
    }
