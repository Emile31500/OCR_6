...
";
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["figure"]) {
            ...
            echo "\" alt=\"";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["figure"], "figure", [], "any", false, false, false, 28), "nom", [], "any", false, false, false, 28), "html", null, true);
            echo "\"/>
            <div class=\"card-body\">
                <a href=\"";
            // line 30
...
";
    ...
    {
        return array (  227 => 60,  217 => 59,  204 => 57,  194 => 56,  176 => 47,  154 => 31,  150 => 30,  142 => 28,  139 => 27,  135 => 26,  132 => 25,  122 => 24,  93 => 6,  83 => 5,  62 => 3,  39 => 1,);
    }
