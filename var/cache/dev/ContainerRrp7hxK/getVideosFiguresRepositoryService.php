 ...
 */
class getVideosFiguresRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\VideosFiguresRepository' shared autowired service.
     *
     * @return \App\Repository\VideosFiguresRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'VideosFiguresRepository.php';

        return $container->privates['App\\Repository\\VideosFiguresRepository'] = new \App\Repository\VideosFiguresRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
