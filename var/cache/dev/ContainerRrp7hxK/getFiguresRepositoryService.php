 ...
 */
class getFiguresRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\FiguresRepository' shared autowired service.
     *
     * @return \App\Repository\FiguresRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FiguresRepository.php';

        return $container->privates['App\\Repository\\FiguresRepository'] = new \App\Repository\FiguresRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
