 ...
 */
class getPhotosFiguresRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PhotosFiguresRepository' shared autowired service.
     *
     * @return \App\Repository\PhotosFiguresRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PhotosFiguresRepository.php';

        return $container->privates['App\\Repository\\PhotosFiguresRepository'] = new \App\Repository\PhotosFiguresRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
