...
class App_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('xFjXtxVdmj', 0, ($this->targetDir.''.'/pools/app'), ($this->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('5NL49X+8As', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('xnC10Vz+KT', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\BrouillonFiguresRepository' => ['privates', 'App\\Repository\\BrouillonFiguresRepository', 'getBrouillonFiguresRepositoryService', true],
            'App\\Repository\\BrouillonPhotoFigureRepository' => ['privates', 'App\\Repository\\BrouillonPhotoFigureRepository', 'getBrouillonPhotoFigureRepositoryService', true],
            'App\\Repository\\BrouillonVideoFigureRepository' => ['privates', 'App\\Repository\\BrouillonVideoFigureRepository', 'getBrouillonVideoFigureRepositoryService', true],
            'App\\Repository\\FiguresRepository' => ['privates', 'App\\Repository\\FiguresRepository', 'getFiguresRepositoryService', true],
            'App\\Repository\\MessagesRepository' => ['privates', 'App\\Repository\\MessagesRepository', 'getMessagesRepositoryService', true],
            'App\\Repository\\PhotosFiguresRepository' => ['privates', 'App\\Repository\\PhotosFiguresRepository', 'getPhotosFiguresRepositoryService', true],
            ...
            'App\\Repository\\VideosFiguresRepository' => ['privates', 'App\\Repository\\VideosFiguresRepository', 'getVideosFiguresRepositoryService', true],
        ], [
            'App\\Repository\\BrouillonFiguresRepository' => '?',
            'App\\Repository\\BrouillonPhotoFigureRepository' => '?',
            'App\\Repository\\BrouillonVideoFigureRepository' => '?',
            'App\\Repository\\FiguresRepository' => '?',
            'App\\Repository\\MessagesRepository' => '?',
            'App\\Repository\\PhotosFiguresRepository' => '?',
            'App\\Repository\\UtilisateursRepository' => '?',
            'App\\Repository\\VideosFiguresRepository' => '?',
        ])));
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Ji0cT8VGCJ', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('Yx6O1TbBNF', 0, ($this->targetDir.''.'/pools/app'), ($this->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ovkWBjONQl', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('l9a2Kc-j7R', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('JRq2zf4KbI', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('XR7-V5qdwg', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
