 ...
 */
class getBrouillonVideoFigureRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BrouillonVideoFigureRepository' shared autowired service.
     *
     * @return \App\Repository\BrouillonVideoFigureRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BrouillonVideoFigureRepository.php';

        return $container->privates['App\\Repository\\BrouillonVideoFigureRepository'] = new \App\Repository\BrouillonVideoFigureRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
